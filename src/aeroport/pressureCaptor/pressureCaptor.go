...
func main() {
	...
	for _, airportCode := range codesAeroport {
		...
		client_pub.Publish(urlBroker+"/airport/"+"airportCode"+"/sensor/pressure", 0, false, jsonDatas) //topic à changer
